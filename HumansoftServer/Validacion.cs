...
namespace HumansoftServer
{
    ...
    {
        public static Regex reInyeccionSQL = new Regex("--|select|from|\\*|delete|truncate|scheme|update|\\salter\\s", RegexOptions.IgnoreCase);
        ...
        public static Boolean PuedeVerEmpleado(int cve_usuario, string num_empleado)
        {
            ...
            try
            {
                DataSet ds = new Modelo(HttpContext.Current.Server.MapPath("~") + "/Modulos/Seguridad/SeguridadModelo/dboSeguridad.xml", true).GenerarOperacionCX("EsEmpleadoVisible", "Visibilidad", new object[,] { 
        ...
        public static Boolean PuedeVerPosicion(int cve_usuario, int num_posicion)
        {
            ...
            try
            {
                DataSet ds = new Modelo(HttpContext.Current.Server.MapPath("~") + "/Modulos/Seguridad/SeguridadModelo/dboSeguridad.xml", true).GenerarOperacionCX("EsPosicionVisible", "Visibilidad", new object[,] { 
                    { "Clave de usuario", "cve_usuario", cve_usuario, true, "int", 0 } 
        ...
        public static bool esFormatoPermitido(object valor, string datosTipo, int longitud)
        {
            ...
            {
                if(reInyeccionSQL.IsMatch(valor.ToString()))
                {
