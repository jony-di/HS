...
<script runat="server">
    ...
    Modelo oModelo = new Modelo("/SeguridadModelo/dboEmpresas.xml");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (seccion != null)
        {
            switch (Request["op"])
            {
                case "Nuevo": oModelo.GenerarOperacionCX("Nuevo", seccion, new object[,] { { "Clave de usuario", "IdUsuarioCreo", Session["cve_usuario"], true, "int", 0 } }).WriteXml(Response.OutputStream); break;
