                ...
                <div class="principal" id="principal">
                    <div class="catalogo">
                        <div class="smart-green">
                            <h2 class="modulos encabezadoformulario" >Catálogo de Módulos</h2>
                            <div class="busqueda"><input class="buscar" id="buscar" placeholder="Buscar en todos los Módulos" onkeyup="buscarCoincidencias(event,this);"/> </div>
                            <button class="btn agregar" id="btnagregar" onclick="MostrarNuevoModulo()">Agregar</button>
                    ...
                    <div class="formulario ">
                         <form id="frmNuevoModulos" onsubmit="return false;">
                            <div class="alinear smart-green">
                                <h2 class="modulos encabezadoformulario" >Crear Nuevo Módulo</h2>
                                ...
                                <div class="scrollable" offset="330">
                                    ...
                                    <input id="clave" name="cve_modulo" class="clave" readonly />
                                    <label class="nombre">Nombre</label> 
                                    <input id="nombre" name="nombre" class="nombre" maxlength="79" placeholder="NombreMódulo" />
                                ...
                                <div class="barra-botones">
                                    <span>
                                        <button class="guardar btnFormularios" onclick="GuardarModulo()">Guardar</button>
                                        <button class="cancelar btnFormularios" onclick="CancelarModulo()">Salir</button>
                                    </span>
                                </div>
                            </div>
                        </form>
