...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link href="css/pais.css" rel="stylesheet" type="text/css" />
                ...
                <div class="principal" id="principal">
                    <div class="catalogo">
                        <div class="smart-green">
                            <h2 class="pais encabezadoformulario" >Catálogo de Países</h2>
                            <div class="busqueda"><input class="buscar" id="buscar" placeholder="Buscar en todos los Países" onkeyup="buscarCoincidencias(event,this);"/> </div>
                            <button class="btn agregar" id="btnagregar" onclick="MostrarNuevoPais()">Agregar</button>
                    ...
                    <div class="formulario ">
                         <form id="frmNuevoPais" onsubmit="return false;">
                            <div class="alinear smart-green">
                                <h2 class="pais encabezadoformulario" >Crear Nuevo País</h2>
                                ...
                                <div class="scrollable" offset="330">
                                    ...
                                    <input id="clave" name="cve_pais" class="clave" readonly />
                                    <label class="nombre">Nombre</label> 
                                    <input id="nombre" name="nombre" class="nombre" maxlength="79" placeholder="NombrePaís" />
                                </div>
                                <hr  class="cleaner"/>
                                <div class="barra-botones">
                                    <span>
                                        <button class="guardar btnFormularios" onclick="GuardarPais()">Guardar</button>
                                        <button class="cancelar btnFormularios" onclick="CancelarPais()">Salir</button>
                                    </span>
                                </div>
                            </div>
                        </form>
