...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link href="css/tiposuc.css" rel="stylesheet" type="text/css" />
        <script src="../../../Recursos/js/jquery-2.1.3.min.js" type="text/javascript"></script>
        <script src="js/tiposuc.js" type="text/javascript"></script>
                ...
                <div class="principal" id="principal">
                    <div class="catalogo">
                        <div class="smart-green">
                            <h2 class="tiposuc encabezadoformulario" >Catálogo de Tipo Sucursal</h2>
                            <div class="busqueda"><input class="buscar" id="buscar" placeholder="Buscar en todos los Tipos Sucursales" onkeyup="buscarCoincidencias(event,this);"/> </div>
                            <button class="btn agregar" id="btnagregar" onclick="MostrarNuevoTipoSuc()">Agregar</button>
                    ...
                    <div class="formulario ">
                         <form id="frmNuevoTipoSuc" onsubmit="return false;">
                            <div class="alinear smart-green">
                                <h2 class="tipo encabezadoformulario" >Crear Nuevo Tipo Sucursal</h2>
                                ...
                                <div class="scrollable" offset="330">
                                    ...
                                    <input id="clave" name="cve_tipo" class="clave" readonly />
                                    <label class="nombre">Nombre</label> 
                                    <input id="nombre" name="nombre" class="nombre" maxlength="79" placeholder="Nombre Tipo" />
                                ...
                                <div class="barra-botones">
                                    <span>
                                        <button class="guardar btnFormularios" onclick="GuardarTipoSuc()">Guardar</button>
                                        <button class="cancelar btnFormularios" onclick="CancelarTipoSuc()">Salir</button>
                                    </span>
                                </div>
                            </div>
                        </form>
