...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        switch (Request["op"])
        {
            case "NuevoTipoPlantilla": Nuevo(); break;
            case "CambiarEstatusActivo": CambiarEstatusActivo(); break;
            case "EditarTipoPlantilla": Editar(); break;
            case "obtenerCatalogoTipoPlantilla": ObtenerCatalogo(); break;
    ...
    public void ObtenerSiguienteClave()
    {
        DataSet ds = new Modelo().GenerarOperacion(
            new object[0, 0], "PA_ES_CObtenerSiguienteClaveTiposPlantilla"
        );
    ...
    public void Nuevo()
    {
        DataSet ds = new Modelo().GenerarOperacion(
            new object[,] { 
                    { "Clave de tipo plantilla", "cve_tipoplantilla", Request["cve_tipoplantilla"],true,"int", 0}
                ,  { "Descripción", "descripcion", Request["descripcion"],true,"string", 150}
                , { "Activo", "activo","true", true ,"bool", 0}
            }
            , "PA_ES_INuevoTipoPlantilla"
        );
        ds.WriteXml(Response.OutputStream);
    }
    ...
    public void CambiarEstatusActivo()
    {
        DataSet ds = new Modelo().GenerarOperacion(
            ...
            , "PA_ES_UCambiarEstatusActivoTipoPlantilla"
        );
        ds.WriteXml(Response.OutputStream);
    }
    ...
    public void Editar()
    {
        DataSet ds = new Modelo().GenerarOperacion(
            ...
            , "PA_ES_UActualizarTipoPlantilla"
        );
        ds.WriteXml(Response.OutputStream);
    }
