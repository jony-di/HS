...
<head runat="server">
     <title></title>
        ...
        <link href="../../ControlAcceso/ControlAccesoUI/css/esquemaFlujo.css?ver=1.0" rel="stylesheet" />
                ...
                <div class="principal" id="principal" style="width:3000px;"><!-- Carrete-->
                    <div class="ventana">
                        <div class="smart-green">
                            <h2 class="encabezadoformulario" >Flujos de contratación</h2>
                    ...
                    <div class="formulario ventana" id="frmFlujo">
                         <form id="frmNuevoFlujo" class="smart-green" onsubmit="return false;">
                            ...
                            <div class="columnaI" offset="280">
                                ...
                                <span class="campo-par"><label>Descripción</label><input id="descripcion" name="descripcion" style="width:280px;" /></span>
                                <span class="campo-par"><label>Objetivo</label><textarea id="objetivo" name="objetivo" style="width:280px;"></textarea></span>
                            </div>
                    ...
                    <div class="formulario ventana ventanaPaso" name="formulario" id="ventanaClonable">
                         <form class="smart-green" onsubmit="return false;" name="frmPaso">
                            ...
                            <div>
                                <fieldset><legend>Seleccione etapa</legend>
                                    <select class="listaEstatus" style="width:60%;margin:auto;display:block;" name="cve_etapa"></select>
