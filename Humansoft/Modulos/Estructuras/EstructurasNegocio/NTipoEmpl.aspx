...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        switch (Request["op"])
        {
            case "NuevoTipoEmpl": Nuevo(); break;
            case "CambiarEstatusActivo": CambiarEstatusActivo(); break;
            case "EditarTipoEmpl": Editar(); break;
            case "obtenerCatalogoTipoEmpl": ObtenerCatalogo(); break;
    ...
    public void ObtenerSiguienteClave()
    {
        DataSet ds = new Modelo().GenerarOperacion(
            new object[0, 0], "PA_ES_CObtenerSiguienteClaveTipoEmpl"
        );
    ...
    public void CambiarEstatusActivo()
    {
        DataSet ds = new Modelo().GenerarOperacion(
            ...
            , "PA_ES_UCambiarEstatusActivoTipoEmpl"
        );
        ds.WriteXml(Response.OutputStream);
    }
