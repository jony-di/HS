...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        switch (Request["op"])
        {
            case "NuevoNacionalidad": Nuevo(); break;
            case "CambiarEstatusActivo": CambiarEstatusActivo(); break;
            case "EditarNacionalidad": Editar(); break;
            case "obtenerCatalogoNacionalidad": ObtenerCatalogo(); break;
    ...
    public void ObtenerSiguienteClave()
    {
        DataSet ds = new Modelo().GenerarOperacion(
            new object[0, 0], "PA_ES_CObtenerSiguienteClaveNacionalidad"
        );
    ...
    public void Nuevo()
    {
        DataSet ds = new Modelo().GenerarOperacion(
            new object[,] { 
                   { "Clave de tipo pago", "cve_nacionalidad", Request["cve_nacionalidad"],true,"int", 0}
                ,  { "Descripción", "descripcion", Request["descripcion"],true,"string", 150}
                ,  { "Activo", "activo","true", true ,"bool", 0}
            }
            , "PA_ES_INuevoNacionalidad"
        );
        ds.WriteXml(Response.OutputStream);
    }
    ...
    public void CambiarEstatusActivo()
    {
        DataSet ds = new Modelo().GenerarOperacion(
            ...
            , "PA_ES_UCambiarEstatusActivoNacionalidad"
        );
        ds.WriteXml(Response.OutputStream);
    }
