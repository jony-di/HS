...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        switch (Request["op"])
        {
            case "NuevoSegmentos": Nuevo(); break;
            case "CambiarEstatusActivo": CambiarEstatusActivo(); break;
            case "EditarSegmentos": Editar(); break;
            case "obtenerCatalogoSegmentos": ObtenerCatalogo(); break;
    ...
    public void ObtenerSiguienteClave()
    {
        DataSet ds = new Modelo().GenerarOperacion(
            new object[0, 0], "PA_ES_CObtenerSiguienteClaveSegmento"
        );
    ...
    public void CambiarEstatusActivo()
    {
        DataSet ds = new Modelo().GenerarOperacion(
            ...
            , "PA_ES_UCambiarEstatusActivoSegmento"
        );
        ds.WriteXml(Response.OutputStream);
    }
